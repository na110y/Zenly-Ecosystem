...
| 002   | [P1-I002 — Kiểm tra cấu hình môi trường](002_KIEM_TRA_CAU_HINH_MOI_TRUONG.md)                                     | foundation | 001                          | P1-ARCH, P1-SEC, P1-INFRA                    | DONE        |
| 003   | [P1-I003 — Docker local với PostgreSQL](003_DOCKER_LOCAL_VOI_POSTGRESQL.md)                                       | foundation | 001, 002                     | P1-ARCH, P1-INFRA                            | DONE        |
| 004   | [P1-I004 — Prisma migration và seed nền](004_PRISMA_MIGRATION_VA_SEED_NEN.md)                                     | foundation | 003                          | P1-DATA, P1-QA                               | DONE        |
| 005   | [P1-I005 — Chuẩn response lỗi và request context](005_CHUAN_RESPONSE_LOI_VA_REQUEST_CONTEXT.md)                   | foundation | 001, 002                     | P1-API, P1-SEC                               | DONE        |
| 006   | [P1-I006 — CI nền và quality gate tối thiểu](006_CI_NEN_VA_QUALITY_GATE_TOI_THIEU.md)                             | foundation | 001, 004, 005                | P1-QA                                        | DONE        |
| 010   | [P1-I010 — Schema user và session public](010_SCHEMA_USER_VA_SESSION_PUBLIC.md)                                   | identity   | 004                          | P1-DATA, P1-SEC                              | DONE        |
| 011   | [P1-I011 — Đăng ký và xác minh email user](011_DANG_KY_VA_XAC_MINH_EMAIL_USER.md)                                 | identity   | 002, 010                     | P1-PUBLIC, P1-FLOW, P1-API, P1-SEC           | DONE        |
| 012   | [P1-I012 — Login logout và session user](012_LOGIN_LOGOUT_VA_SESSION_USER.md)                                     | identity   | 010, 011                     | P1-FLOW, P1-API, P1-SEC                      | DONE        |
| 013   | [P1-I013 — Quên và đặt lại mật khẩu user](013_QUEN_VA_DAT_LAI_MAT_KHAU_USER.md)                                   | identity   | 010, 012                     | P1-PUBLIC, P1-API, P1-SEC                    | DONE        |
| 014   | [P1-I014 — Hồ sơ và cài đặt thông báo user](014_HO_SO_VA_CAI_DAT_THONG_BAO_USER.md)                               | identity   | 012                          | P1-PUBLIC, P1-DATA, P1-API                   | DONE        |
| 015   | [P1-I015 — Schema admin và bootstrap Super Admin](015_SCHEMA_ADMIN_VA_BOOTSTRAP_SUPER_ADMIN.md)                   | identity   | 004, 002                     | P1-ADMIN, P1-DATA, P1-SEC                    | DONE        |
| 016   | [P1-I016 — Thiết lập TOTP lần đầu](016_THIET_LAP_TOTP_LAN_DAU.md)                                                 | identity   | 015                          | P1-ADMIN, P1-FLOW, P1-API, P1-SEC            | DONE        |
| 017   | [P1-I017 — Đăng nhập Admin bắt buộc TOTP](017_DANG_NHAP_ADMIN_BAT_BUOC_TOTP.md)                                   | identity   | 016, 005                     | P1-ADMIN, P1-FLOW, P1-API, P1-SEC            | DONE        |
| 018   | [P1-I018 — RBAC middleware và menu theo role](018_RBAC_MIDDLEWARE_VA_MENU_THEO_ROLE.md)                           | identity   | 017                          | P1-ADMIN, P1-API, P1-SEC                     | DONE        |
| 019   | [P1-I019 — Quản trị admin và bảo vệ Super Admin cuối](019_QUAN_TRI_ADMIN_VA_BAO_VE_SUPER_ADMIN_CUOI.md)           | identity   | 018                          | P1-ADMIN, P1-DATA, P1-SEC                    | DONE        |
| 020   | [P1-I020 — Runtime feature flags và System UI](020_RUNTIME_FEATURE_FLAGS_VA_SYSTEM_UI.md)                         | identity   | 018, 019                     | P1-ADMIN, P1-DATA, P1-API                    | IN_PROGRESS |
